    ...
    <div className="dashboard-container">
      ...
      <main className="main-content">
        <section className="hero-banner">
          ...
          <p>
            Monitore em tempo real temperatura, umidade, luminosidade e fluxo de
            pessoas. Tenha controle total e insights visuais para a gestão
            eficiente dos ambientes.
          </p>
        </section>
        ...
        <section className="monitoring-section">
          ...
          <div className="sensor-grid">
            <div
              ...
              onClick={() => irParaSensor("temperatura")}
            >
            ...
            <div
              className="sensor-circle"
              onClick={() => irParaSensor("luminosidade")}
            >
              <span className="sensor-icon">☀️</span>
